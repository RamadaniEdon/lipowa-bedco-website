...
export default function Footer() {
    return (
        <footer className="bg-[#2F2F2F] w-full text-[#E6E7E8]">
            <div className={cn(SIDE_SPACES.MARGIN, "mb-[42px]")}>
                <div className="h-[700px] pt-[80px]">
                    <div className="h-full flex justify-between">
                        <div className="h-full flex flex-col justify-between">
                            <p className="text-[23.7px] w-[425px]">
                            ...
                            <PageIcon className="w-[352px] h-[157.12px]" />
                        </div>
                        <div className="flex flex-col justify-between">
                            <div className="flex justify-between gap-[154px]">
                                <div className="flex flex-col gap-[16px] min-w-[140px]">
                            ...
                            <div className="flex justify-between font-silka-mono items-center mb-10">
                                <div className="uppercase flex gap-[113px]">
                                    <p className="text-[16px]">
                                        CALL US: +123 456 789
                                    </p>
                                    <p>EMAIL: info@lipowa.com</p>
                                </div>
                                <Button
                                    className={cn(
        ...
        <div className={cn("border-t-[#E7E8E9]/10 border-t-[1px]", className)}>
            <div
                className={cn(
                    ...
                    "text-[#E6E7E8] uppercase font-silka-mono text-[16px]",
