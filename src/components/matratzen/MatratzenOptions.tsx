...
export default function MatratzenOptions({
    ...
    return (
        ...
        >
            <RevealFromBottom className="flex-1 h-full delay-[200ms]">
            ...
            <RevealFromBottom className="flex-1 h-full delay-[400ms]">
                <HiddenCardOptionsItem
                    className="h-full"
                    img={Matratzen2Img}
            ...
            <RevealFromBottom className="flex-1 h-full delay-[600ms]">
                <HiddenCardOptionsItem
                    className="h-full"
                    img={Matratzen3Img}
            ...
            <RevealFromBottom className="flex-1 h-full delay-[800ms]">
                <HiddenCardOptionsItem
                    className="h-full"
                    img={Matratzen4Img}
