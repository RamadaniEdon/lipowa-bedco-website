...
import { RevealFromBottom, RevealFromLeft } from "@/components/ui/Reveal";
...
export default function MatratzenOneVariants({
    ...
    return (
        <div className={cn("grid grid-cols-3 grid-rows-2 gap-5", className)}>
            <RevealFromLeft>
                <div className="pr-[95px] h-full flex flex-col justify-end">
                    <h3 className="text-[46px] text-[#3B3B3B] mb-[60px]">
                        Komfort durch Kaltschaum
                    </h3>
                    <p className="text-[18px] text-[#AEAEAE]">
                        Kaltschaummatratzen bieten eine ausgewogene Kombination
                        aus Stützkraft und Anpassungsfähigkeit. Dank ihrer
                        punktelastischen Struktur reagieren sie präzise auf jede
                        Körperzone und sorgen für ein angenehmes, ruhiges
                        Liegegefühl.
                        <br />
                        <br />
                        Unsere Modelle werden in sorgfältiger Handarbeit
                        gefertigt und sind in verschiedenen Höhen, Schnitten und
                        Härtegraden erhältlich.
                    </p>
                </div>
            </RevealFromLeft>
            <RevealFromBottom className="h-[727px] delay-[500ms]">
            ...
            <RevealFromBottom className="h-[727px] delay-[700ms]">
                <HiddenItemWithDescription
                    className="h-full"
                    img={Image2}
                    title="Prestige"
                    description={
                        <p className="text-[20px] text-[#AEAEAE]">
                            ...
                            Anpassungsfähigkeit und körpergerechte
                            Punktelastizität.
                            <br />
                            <br />
                            Härtegradempfehlung:
            ...
            <RevealFromBottom className="h-[727px] delay-[800ms]">
                <HiddenItemWithDescription
                    className="h-full"
                    img={Image3}
                    title="Flex"
            ...
            <RevealFromBottom className="h-[727px] delay-[1000ms]">
                <HiddenItemWithDescription
                    className="h-full"
                    img={Image4}
                    title="Sanimed"
                    description={
                        <p className="text-[20px] text-[#AEAEAE]">
                            ...
                            <br />
                            <br />
                            Diese Kaltschaummatratze in Kernhöhe 16 cm
                            (Raumgewicht 55) ermöglicht durch ihren
                            hervorragenden Längs- und Querschnitt in 7
                            Zonen-Ausführung höchste Anpassungsfähigkeit an die
                            unterschiedlichen Körperzonen. Sie garantiert ein
                            ergonomisches Schlafen in jeder Liegeposition.
                            <br />
                            <br />
                            Härtegradempfehlung:
                            <br />
            ...
            <RevealFromBottom className="h-[727px] delay-[1200ms]">
                <HiddenItemWithDescription
                    className="h-full"
                    img={Image5}
                    ...
                    description={
                        <p className="text-[20px] text-[#AEAEAE]">
                            ...
                            <br />
                            <br />
                            Diese Kaltschaummatratze präsentiert die
                            hervorragenden Eigenschaften des Modells Sanimed in
                            einer Komforthöhe von 18 cm
                            <br />
                            <br />
                            Härtegradempfehlung:
                            <br />
