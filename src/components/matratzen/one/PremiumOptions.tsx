...
export default function PremiumOptions({
    ...
    return (
        <div className={cn("grid grid-cols-3 grid-rows-1 gap-5", className)}>
            <RevealFromLeft>
                <div className="mr-[100px] h-full flex flex-col justify-end">
                    ...
                    <p className="text-[18px] text-[#3B3B3B]">
                        ...
                        dabei Gemütlichkeit und einladende
                        <br /> <br />
            ...
            <RevealFromBottom className="delay-[200ms]">
                <HiddenItemWithDescription
                    ...
                    description={
                        <p className="text-[20px] text-[#AEAEAE]">
                            ...
                            <br />
                            <br />
                            Diese Kaltschaummatratze bietet mit ihrem
                            Würfelschnitt und ihrer profilierten Oberfläche ein
                            Höchstmaß an Anpassungsfähigkeit. Die Kernhöhe
                            dieser Matratze beträgt 18 cm (Raumgewicht 55).
                            <br />
                            <br />
                            Härtegradempfehlung:
                            <br />
            ...
            <RevealFromBottom className="delay-[500ms]">
                <HiddenItemWithDescription
                    className="h-[727px] bg-white"
                    img={Image2}
                    title="Elegance"
                    description={
                        <p className="text-[20px] text-[#AEAEAE]">
                            ...
                            <br />
                            <br />
                            Diese exzellente Kaltschaummatratze wurde
                            insbesondere für Personen mit Schulterproblemen
                            entwickelt.Der spezielle Schulterschnitt in
                            Verbindung mit einer Lordose-Einlage im
                            Taillenbereich verspricht ein Höchstmaß an
                            Anschmiegsamkeit, besonders im Schulterbereich, aber
                            auch in allen anderen Körperzonen. Die Kernhöhe
                            dieser Matratze beträgt 20 cm (Raumgewicht 55).
                            <br />
                            <br />
                            Härtegradempfehlung:
                            <br />
