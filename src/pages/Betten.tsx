        ...
        <div className={cn(className)}>
            ...
            <div className="bg-[#2F2F2F] mb-[60px] md:mb-[80px] lg:mb-[120px] py-[60px] md:py-[80px] lg:py-[120px] text-white">
                <RevealFromBottom>
                    ...
                    >
                        ...
                        <p className="text-[32px] sm:text-[42px] md:text-[56px] lg:text-[72px] leading-tight text-left md:text-right">
                            Familienbetten für gemeinsame Momente, gemütliche
                            Morgen und erholsame Nächte – für Komfort und
                            Zusammenhalt in Ihrem Zuhause.
                        </p>
                    </div>
                </RevealFromBottom>
                <RevealFromBottom>
                ...
                >
                    <RevealFromLeft>
                        <p>
                            Unsere Familienbetten sind sowohl für Eltern als
                            auch Kinder konzipiert und bieten viel Platz für
                            alle, ohne dabei Gemütlichkeit und einladende
                    ...
                    <RevealFromRight>
                        <p>
                            ...
                            lässt sich jedes Bett perfekt an Ihr Zuhause und
                            Ihren Lebensstil anpassen. Handgefertigt mit
                            derselben Liebe zum Detail wie unsere anderen
                            Betten, erfüllen sie die hohen Standards von Lipowa
                            in puncto Komfort, Langlebigkeit und Qualität und
                            werden so zu einem langlebigen Mittelpunkt des
                            Familienlebens.
                        </p>
                    </RevealFromRight>
                </div>
